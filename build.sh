...
xcc -report -O3 -lquadflash -fxscope $1.c flexfx.xn flexfx.xc.o \
...
lib_dsp_idct.xc lib_dsp_fft.xc lib_dsp_fft_forward.S lib_dsp_fft_inverse.S lib_dsp_fft_merge_spectra.S lib_dsp_fft_split_spectrum.S lib_dsp_long_short_conversion.S \
lib_dsp_adaptive.c lib_dsp_dct.xc lib_dsp_design.c lib_dsp_filters.c lib_dsp_math.c lib_dsp_matrix.c lib_dsp_statistics.c lib_dsp_tables.c lib_dsp_vector.c \
-o $1.xe
